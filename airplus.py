...
▐   ▐   █       █ ▐     ▐       █           █                  ▐      
        ▐       ▐               ▐           ▐                         
                 AIRPLUS DDOS MAKE BY PHAM HUU DUONG
'''
...
(.-./`-'\.-.)        ╚═╝  ╚═╝ ╚═════╝  ╚═════╝     ╚═════╝  ╚═════╝  ╚═════╝ ╚═╝  ╚═══╝ ╚═════╝     ╚═════╝ ╚═════╝  ╚═════╝ ╚══════╝
   '''+Style.RESET_ALL+Fore.YELLOW+Style.BRIGHT+''' 
                           DDOS TOOL MAKE BY PHAM HUU DUONG
...
by: Pham Huu Duong   
    ...
    try:
        while True:
            banner()
            print(Fore.GREEN+Style.BRIGHT+"1."+Style.RESET_ALL+Fore.YELLOW+" URL WEB"+Fore.GREEN+Style.BRIGHT+"\n2."+Style.RESET_ALL+Fore.YELLOW+" Địa Chỉ IP"+Fore.GREEN+Style.BRIGHT+"\n3."+Style.RESET_ALL+Fore.YELLOW+" Hủy")
            opt=str(input(Fore.RED+Style.BRIGHT+"\n>>> "+Fore.RESET))
            if opt=='1':
                domain=str(input(Fore.CYAN+Style.BRIGHT+"Ingrese el sitio web(VD:google.com):"+Fore.RESET))
